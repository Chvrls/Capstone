...
function renderSignUpPage() {
  const renderSignUpHTML = `
    <form action="/signup" class="d-flex flex-column align-items-center">
      ...
      <button type="submit" class="btn btn-lg btn-outline-dark col-lg-10">Sign Up</button>
    </form>
    <div>
    ...
    <div class="d-flex justify-content-center mt-3">
      <button class="btn btn-lg btn-outline-dark col-lg-10" id="login-btn">Login</button>
    </div>`;
